...
The HaLo gateway allows a desktop browser to interact with HaLo chips without the need for a dedicated NFC scanner. It accomplishes this through a secure WebSocket connection between the desktop browser and a scanning webpage on a compatbile smartphone. It's integrated directly with LibHaLo and can also be used in a CLI context -- for example to integrate HaLo chips directly into Hardhat tests.
