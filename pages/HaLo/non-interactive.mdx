# NDEF Non-Interactive Mode

`Version c3+ Only` When no command was explicitly written by the user during the chip's last scan, it will automatically generate the default command which signs a unique challenge using key slot #2.
