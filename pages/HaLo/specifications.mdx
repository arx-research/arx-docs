...
<VideoGrid videos={[
    ...
    {src: '/videos/creditcard.mp4', caption: 'CR80 card form factors'},
    {src: '/videos/hangtag.mp4', caption: 'Rectangular 30x50mmm tag'},
    {src: '/videos/wristband.mp4', caption: 'Wrist bracelet tag'}
]}/>
