...
<VideoGrid videos={[
    {src: '/videos/chip.mp4', caption: 'Round, 27mm diameter tag'},
    {src: '/videos/creditcard.mp4', caption: 'Rectangular 30x50mmm tag'},
    {src: '/videos/hangtag.mp4', caption: 'Wrist bracelet tag '},
    {src: '/videos/wristband.mp4', caption: 'CR80 card form factors'}
]}/>
