...
HaLo chips include ISO 7816, ISO 14443 interfaces. See [Overview](../HaLo/overview) for more detail on these interfaces. At the core of their functionality, HaLos generate and store secp256k1 keypairs that can be used to sign messages and transactions on- or off-chain. 

By design, HaLos do not expose any interface for the extraction, deletion or replacement of these keypairs.
