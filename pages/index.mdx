...
At the heart of every Arx secure chip is a cryptographic identity that can be used to authenticate the chip on-chain permissionlessly. These include the SiLo and [HaLo](../category/halo) which use ECDSA signatures for authentication as well as to carry out on-chain actions.
...
- Unlock your doors with chip signatures [Twitter](https://twitter.com/andy_gao_1/status/1547271517729263617?s=20)